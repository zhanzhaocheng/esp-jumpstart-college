...
#ifndef __YURI_TCP_H__
#define __YURI_TCP_H__
#include "sdkconfig.h"
...
#define TAG "YuriTCP-->" //打印的tag

//以下是softAP热点模式的配置信息
#define SOFT_AP_SSID "YuriEspressif"
...
#define GATEWAY_SSID "HONOR"

#define GATEWAY_PAS "12345678"

#define TCP_SERVER_ADRESS "10.193.41.9" //要连接TCP服务器地址
